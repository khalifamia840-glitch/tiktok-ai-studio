...
import { Video, Library, LayoutDashboard, Settings, LogOut, Menu, X, Sparkles } from 'lucide-react'
...
function AppContent() {
  ...
  const navItems = [
    { to: '/', icon: Video, label: 'Crear Video' },
  ...
  return (
    <div className="min-h-screen flex bg-[#010101] text-white overflow-hidden">
      ...
      {/* Main Content */}
      <main className="flex-1 h-screen overflow-y-auto pt-16 lg:pt-0 sidebar-scroll">
        <Routes>
